...
class Reportdailymachine_controller extends CI_Controller {
    ...
    function __construct()
    {
        ...
        $this->load->model('reportdailymachine_model');
    ...
    function export_pdf(){ 
                ...
                $this->load->vars( $var );  
                $data['data'] = $this->reportdailymachine_model->get_data($tanggal_awal);    
                $data['data_count'] = $this->reportdailymachine_model->get_data_count($tanggal_awal);    
                $data['material'] = $this->analisa_model->get_material($param = 'floculant');
                $data['tanggal']=$tanggal_awal; 
                $this->load->view( $url. '/cetak_report_machine_daily',$data);
