...
for ($x = 1; $x <= 9; $x++) {
    ...
    */
    ...
    switch ($x){
        ...
        case 4: 
            $nama = "Milk of Lime"; 
            $material = "<input type='hidden' name='material[$x]' value='152'>";
            $colom1 = "hidden";
            $colom2 = "text";
            $colom3 = "hidden";
            $colom4 = "hidden";
        ...
        case 5: 
            $nama = "Lime Tank-1"; 
            $material = "<input type='hidden' name='material[$x]' value='160'>";
            $colom1 = "text";
            $colom2 = "text";
            $colom3 = "hidden";
            $colom4 = "hidden";
        ...
        case 6: 
            $nama = "Lime Tank-2"; 
            $material = "<input type='hidden' name='material[$x]' value='161'>";
            $colom1 = "text";
            $colom2 = "text";
            $colom3 = "hidden";
            $colom4 = "hidden";
        ...
        case 7: 
            $nama = "Lime Tank-3"; 
            $material = "<input type='hidden' name='material[$x]' value='162'>";
            $colom1 = "text";
            $colom2 = "text";
            $colom3 = "hidden";
            $colom4 = "hidden";
        ...
        break;
        case 8: 
            $nama = "Saccharate Lime"; 
            $material = "<input type='hidden' name='material[$x]' value='151'>";
            $colom1 = "hidden";
            $colom2 = "hidden";
            $colom3 = "text";
            $colom4 = "text";
        ...
        case 9: 
            $nama = "Sugar Product"; 
            $material = "<input type='hidden' name='material[$x]' value='39'>";
            $colom1 = "hidden";
            $colom2 = "hidden";
            $colom3 = "hidden";
            $colom4 = "hidden";
    ...
    $input1 .= "<tr class='$class'>
                <td>$x</td>
                <td>$nama $material</td>
                <td ><input type='$colom1' id='input1_$x' name='input1[$x]' class='input-extrasmall text-bold warning ' /></td>
                <td><input type='$colom2' id='input2_$x' name='input2[$x]' class='input-extrasmall text-bold warning ' /></td>
                <td><input type='$colom3' id='input3_$x' name='input3[$x]' class='input-extrasmall text-bold warning ' /></td>
                <td><input type='$colom4' id='input4_$x' name='input4[$x]' class='input-extrasmall text-bold warning ' /></td>  
                <td><input type='$colom5' id='input5_$x' name='input5[$x]' class='input-extrasmall text-bold warning ' /></td>                                           
            </tr>";
