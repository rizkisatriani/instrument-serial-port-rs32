...
$select = '';
foreach (opsi_db('parameter_analisa','','','P022') as $key=>$val ) {
    if ($key=='P022'){$select='selected';}else{$select = '';}
                  ...
                  <div class="cell-md-6 p-4">
                    <form name="analisa" id="analisa">
                        <input type="hidden" name="id_modul" id='id_modulinput' >
                         ...
                         <div class="row mb-2">
                             <label class="cell-sm-2">Blangko</label>
                             <div class="cell-sm-10">
                                 <input type="text"  name='input[]' id='blangko' class="input"
                                  data-role="input"
                         ...
                         <div class="row mb-2">
                             <label class="cell-sm-2">Gula</label>
                             <div class="cell-sm-10">
                                 <input type="text"  name='input[]' id='gula' class="input"
                                  data-role="input"
                                  data-cls-input="text-bold"
                                  data-clear-button="false"
                                  value='0'
                         ...
                         <div class="row mb-2">
                             <label class="cell-sm-2">Temperatur Ash</label>
                             <div class="cell-sm-10">
                                 <input type="text"  name='input[]' id='temp' class="input"
                                  data-role="input"
                                  data-cls-input="text-bold"
                                  data-clear-button="false"
                                  value='0'
