...
class PDF extends PDFTable{
	...
	function Header()
	{
		...
		$this->text(0,"DETAIL SUGAR PACKING REPORT",0,'C');
		$this->setStyle('subtitle');
        ...
        $table ="<table align='center' border='1' width='150'>
				<tr bgcolor='#EDEDED'>	
					...
					<td width='$kolom[1]' align='center' valign='middle' size='8' style='B'>Date</td>
					<td width='$kolom[2]' align='center' valign='middle' size='8' style='B'>Weigh (kg)</td>
					<td width='$kolom[3]' align='center' valign='middle' size='8' style='B'>Product</td>
                    <td width='$kolom[4]' align='center' valign='middle' size='8' style='B'>Machine</td>
                    <td width='$kolom[5]' align='center' valign='middle' size='8' style='B'>Reason</td>
				</tr>
			</table>	
			";
