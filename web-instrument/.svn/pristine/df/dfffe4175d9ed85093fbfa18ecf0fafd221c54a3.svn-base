...
class Reportdailymill_controller extends CI_Controller {
    ...
    function __construct()
    {
        ...
        $this->load->model('reportdailymill_model');
    ...
    function export_pdf(){
        ...
        $this->load->vars( $var );  
        $data['data'] = $this->reportdailymill_model->get_data($tanggal_awal);    
        $data['data_count'] = $this->reportdailymill_model->get_data_count($tanggal_awal);     
        $data['tanggal']=$tanggal_awal; 
        $this->load->view( $url. '/cetak_report_mill_daily',$data);
