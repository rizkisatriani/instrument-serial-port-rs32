...
<head>
    ...
    <!-- Metro 4 -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/metro4/build/css/metro-all.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/metro4/build/css/index.css">
...
<script src="<?php echo base_url(); ?>assets/metro4/build/js/jquery/jquery-3.3.1.min.js"></script>
<script src="<?php echo base_url(); ?>assets/metro4/build/js/Chart.bundle.min.js"></script>
<script src="vendors/qrcode/qrcode.min.js"></script>
<script src="vendors/jsbarcode/JsBarcode.all.min.js"></script>
<script src="vendors/ckeditor/ckeditor.js"></script>
<script src="<?php echo base_url(); ?>assets/metro4/build/js/metro.js"></script>
<script src="<?php echo base_url(); ?>assets/metro4/build/js/index.js"></script>
</body>
</html>