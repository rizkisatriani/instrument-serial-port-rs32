 ...
 >
    <thead>
		<tr >
            ...
            <th class='w-10 bg-green fg-white'>PARAMETER</th>
            <th class='w-20 bg-green fg-white'>MATERIAL</th>
            <th class='w-10 bg-green fg-white'>Strike</th>
            <th class="w-10 bg-green fg-white">Brix</th>
            <th class="w-10 bg-green fg-white">Pol</th>
            <th class="w-10 bg-green fg-white">Pty</th>
