...
$select = '';
foreach (opsi_db('parameter_analisa','','','P014') as $key=>$val ) {
    if ($key=='P014'){$select='selected';}else{$select = '';}
                        ...
                        <input type="hidden" name="id_modul" id='id_modulinput' >
                         ...
                         <div class="row">
                             <div class="cell">
                                 ...
                                 <button type="button" class="button success" id='buttonget' title="get data from Sucroflex" onclick="javascript:getAnalisaAlat()"><span class="mif-download"></span> Get data from Sucroflex</button>
