                    ...
                    <form name="analisa" id="analisa">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="cell-sm-10">
                                <input type="text" name="no_analisa" id="no_analisa" value="<?=$nomor?>" disabled readonly>
                            </div>
                        </div>
                         <div class="row mb-2">
                         ...
                         <div class="row mb-2">
                             ...
                             <div class="cell-sm-10">
                                 <input type="text" value='<?=$strike?>'  name='hasil' id='strike' onkeypress="return chekNumber(event)"
                                  data-role="input"
