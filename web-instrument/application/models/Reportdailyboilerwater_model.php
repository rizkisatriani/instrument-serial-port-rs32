...
class Reportdailyboilerwater_model extends CI_Model
{
    ...
    function get_data($date){  
        ...
        $query = $this->db->query('SELECT
                ...
                ON(material_analisa.id_material IN ("M046","M047","M048","M049","M050") )
                LEFT JOIN parameter_analisa
                ON (parameter_analisa.id_parameter=verifikasi_detil.id_parameter)
                WHERE  verifikasi_detil.id_material IN ("M046","M047","M048","M049","M050") 
                 AND verifikasi_detil.id_parameter IN("P003", "P028", "P029", "P030",  "P031", "P032", "P033", "P034", "P035", "P036", "P037", "P038", "P039") AND tanggal="'.$date.'"
