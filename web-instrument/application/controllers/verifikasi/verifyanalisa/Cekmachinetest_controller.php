<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Cekmachinetest_controller extends CI_Controller {
    private $cat;
    private $menu;
    private $submenu;
    private $module;
    ...
    function do_action(){
        ...
        switch($action){
            case 'showdata':
              //$data['analisa'] = $this->analisa_model->show_analisa_verifikasi($param='machine');
			...
			case 'open_form_grid_analisa':
                ...
                $data['tgl'] = $tgl;
                $data['jam'] = $jam; 
                $data['chek'] = $this->analisa_model->chek_verifikasi($tgl,$jam,'machine');
                
                $data['analisa'] = $this->analisa_model->get_process_verifikasi_analisa_tmp($tgl,$jam,$jam2,$param='machine');
            ...
            case 'showdatatable':
                ...
                $data['analisa'] = $this->analisa_model->show_analisa_verifikasi($param='machine',$tanggal);
