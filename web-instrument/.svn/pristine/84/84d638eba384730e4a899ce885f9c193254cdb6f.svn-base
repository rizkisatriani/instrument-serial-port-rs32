...
class Reportdailypan_controller extends CI_Controller {
    ...
    function __construct()
    {
        ...
        $this->load->model('Reportdailypan_model');
    ...
    function export_pdf(){ 
                ...
                $this->load->vars( $var );  
                $data['data'] = $this->Reportdailypan_model->get_data_t1($tanggal_awal);   
                $data['data2'] = $this->Reportdailypan_model->get_data_t2($tanggal_awal);   
                $data['data3'] = $this->Reportdailypan_model->get_data_t3($tanggal_awal);    
                $data['data_count'] = $this->Reportdailypan_model->get_data_count($tanggal_awal);     
                $data['tanggal']=$tanggal_awal; 
                $this->load->view( $url. '/cetak_report_pan_daily',$data); 
    }
