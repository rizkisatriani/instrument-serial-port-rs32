<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Analisapolari_controller extends CI_Controller {
    private $cat;
    private $menu;
    private $submenu;
    private $module;
    ...
    function do_action(){
        ...
        switch($action){
            ...
            case 'open_form_analisa':
                $data['strike'] = $this->analisa_model->show_analisa();
	...
	function simpan_analisa(){
		...
		$simpan = $this->analisa_model->simpan_analisa(true);
    ...
    function get_pengenceran($id){
        
        $this->load->model("helper_model");
        
        $get = $this->helper_model->getPengenceran($id);
        
        $pengenceran = $get['faktor_pengenceran'];
