...
class Reportdailyfloculant_controller extends CI_Controller {
    ...
    function __construct()
    {
        ...
        $this->load->model('reportdailyfloculant_model');
    ...
    function export_pdf(){ 
                ...
                $this->load->vars( $var );  
                $data['data'] = $this->reportdailyfloculant_model->get_data($tanggal_awal);   
                $data['data_avg'] = $this->reportdailyfloculant_model->get_data_avg($tanggal_awal);    
                $data['data_count'] = $this->reportdailyfloculant_model->get_data_count($tanggal_awal);    
                $data['material'] = $this->analisa_model->get_material($param = 'machine');
                $data['tanggal']=$tanggal_awal; 
                $this->load->view( $url. '/cetak_report_floculant_daily',$data);
