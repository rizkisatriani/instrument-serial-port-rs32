<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Analisagrandsize_controller extends CI_Controller {
    private $cat;
    private $menu;
    private $submenu;
    private $module;
    ...
    function do_action(){
        ...
        switch($action){
            ...
            case 'open_form_analisa':
                ...
                //$data['temp'] = $this->helper_model->get_analisa_grandsize_tmp();
	...
	function simpan_analisa(){
        ...
        $delet_temp = $this->helper_model->delete_analisa_grandsize_tmp();

		$simpan = $this->analisa_model->simpan_analisa($paramArray = true);
    ...
    function simpan_sementara(){
        ...
        $simpan = $this->analisa_model->simpan_sementara();
