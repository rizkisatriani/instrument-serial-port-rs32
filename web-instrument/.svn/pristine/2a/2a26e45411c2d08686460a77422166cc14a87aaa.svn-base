...
$material = "";
$parameter = "";
foreach ( opsi_db('material_analisa','','','k11') as $key=>$val ){
...
foreach (opsi_db('parameter_analisa','','','k11') as $key=>$val ) {
                    ...
                    <form name="analisa" id="analisa">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="cell-sm-10">
                                <input type="text" name="namalengkap" value="<?=$nomor?>" disabled readonly>
                            </div>
                        </div>
                         <div class="row mb-2">
