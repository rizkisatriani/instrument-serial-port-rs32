...
class Reportdailyboiling_controller extends CI_Controller {
    ...
    function __construct()
    {
        ...
        $this->load->model('reportdailyboiling_model');
    ...
    function export_pdf(){ 
                ...
                $this->load->vars($var);  
                $data['data1'] = $this->reportdailyboiling_model->get_data_t1($tanggal_awal);    
                $data['data2'] = $this->reportdailyboiling_model->get_data_t2($tanggal_awal);    
                $data['data3'] = $this->reportdailyboiling_model->get_data_t3($tanggal_awal);   
                $data['data4'] = $this->reportdailyboiling_model->get_data_t4($tanggal_awal);     
                $data['data_count'] = $this->reportdailyboiling_model->get_data_count($tanggal_awal);  
                $data['tanggal']=$tanggal_awal; 
                $this->load->view( $url. '/cetak_report_boiling_daily',$data); 
    }
