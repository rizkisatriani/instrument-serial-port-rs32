<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Analisafiber_controller extends CI_Controller {
    private $cat;
    private $menu;
    private $submenu;
    private $module;
    ...
    function do_action(){
        ...
        switch($action){
            ...
            case 'open_form_analisa':
                ...
                //$data['temp'] = $this->helper_model->get_analisa_fiber_tmp();
    ...
    function simpan_analisa(){
        ...
        $this->load->model('helper_model');
        //$delet_temp = $this->helper_model->delete_analisa_fiber_tmp();
