...
$select = '';
foreach (opsi_db('parameter_analisa','','','k09') as $key=>$val ) {
    switch ($key) {
      case 'P009': case 'P053': case 'P054':
                    ...
                    <form name="analisa" id="analisa">
                        ...
                        <input type="hidden" name="hasil_get" id='hasil_get' >
                         ...
                         <div class="row mb-2">
                             ...
                             <div class="cell-sm-10">
                                 <input type="text"  name='input[]' id='brix_pi1' class="input"
                                  data-role="input"
                         ...
                         <div class="row mb-2">
                             <label class="cell-sm-2">Brix Pi 2</label>
                             <div class="cell-sm-10">
                                 <input type="text"  name='input[]' id='brix_pi2' class="input"
                                  data-role="input"
                                  data-cls-input="text-bold"
                                  data-clear-button="false"
                                  value='0'
