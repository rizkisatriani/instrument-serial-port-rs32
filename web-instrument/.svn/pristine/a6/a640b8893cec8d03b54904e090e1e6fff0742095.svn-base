...
foreach ( opsi_db('material_analisa','','','k01') as $key=>$val ){
    if ($key=='5'){$select='selected';}else{$select='';}
...
$select='';
foreach (opsi_db('parameter_analisa','','','P008') as $key=>$val ) {
    if ($key=='P008'){$select='selected';}else{$select = '';}
                    ...
                    <form name="analisa" id="analisa">
                        <input type="hidden" name="id_modul" id='id_modulinput' >
                         ...
                         <div class="row mb-2">
                             ...
                             <div class="cell-sm-10">
                               <select data-role="select" id='material_analisa' onchange="showStrike()" name='material_analisa' >
                                 <?=$material?>
                               </select>
                             </div>
                         </div>
                         ...
                         <div class="row mb-2" id="divstrike">
                         ...
                         <div class="row">
                             <div class="cell">
                                 ...
                                 <button type="button" class="button success" id='buttonget' title="get data from ph A" onclick="javascript:getAnalisaAlat()"><span class="mif-download"></span> Get data from <?=$module_title?></button>
                                 <button type="button" class="button alert" title="reset this form" onclick="javascript:resetform()"> Reset</button>
                                 <button type="submit" class="button primary" title="Save data"><span class="mif-floppy-disk"></span> Simpan</button>
