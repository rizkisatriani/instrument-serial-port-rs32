...
class Reportdailyboilerwater_controller extends CI_Controller {
    ...
    function __construct()
    {
        ...
        $this->load->model('reportdailyboilerwater_model');
    ...
    function export_pdf(){
                ...
                $this->load->vars( $var );  
                $data['data'] = $this->reportdailyboilerwater_model->get_data($tanggal_awal);    
                $data['data_count'] = $this->reportdailyboilerwater_model->get_data_count($tanggal_awal);     
                $data['tanggal']=$tanggal_awal; 
                $this->load->view( $url. '/cetak_report_boilerwater_daily',$data);
