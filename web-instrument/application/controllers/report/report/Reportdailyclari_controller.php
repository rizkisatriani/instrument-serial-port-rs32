...
class Reportdailyclari_controller extends CI_Controller {
    ...
    function __construct()
    {
        ...
        $this->load->model('reportdailyclari_model');
    ...
    function export_pdf(){
                ...
                $this->load->vars( $var );  
                $data['data1'] = $this->reportdailyclari_model->get_data_t1($tanggal_awal);    
                $data['data2'] = $this->reportdailyclari_model->get_data_t2($tanggal_awal);    
                $data['data3'] = $this->reportdailyclari_model->get_data_t3($tanggal_awal);    
                $data['data_count'] = $this->reportdailyclari_model->get_data_count($tanggal_awal);     
                $data['tanggal']=$tanggal_awal; 
                $this->load->view( $url. '/cetak_report_clari_daily',$data);
