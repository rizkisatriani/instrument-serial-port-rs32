...
foreach ( opsi_db('material_analisa','','','k09') as $key=>$val ){
    if ($key == 4){
            ...
            if ($no == 4){$select='selected';}else{$select = '';}
                            ...
                            <input type="hidden" name="id_modul" id='id_modulinput' >
                             ...
                             <div class="row">
                                 <div class="cell">
                                    ...
                                    <!--<button type="button" class="button info" id='butstart' title="Start Machine" onclick="javascript:startMachine()" ><span class="mif-play"></span>Start Analisa</button> -->
